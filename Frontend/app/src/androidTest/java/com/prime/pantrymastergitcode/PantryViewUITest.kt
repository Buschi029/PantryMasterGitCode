...
class PantryViewUITest {
    ...
    fun pantryViewTest() {
        ...
        val pantryIcon = composeTestRule.onNodeWithTag("Icon1")
        ...
        val pantryList = composeTestRule.onNodeWithTag("PantryList")
